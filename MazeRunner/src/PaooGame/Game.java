...
public class Game implements Runnable
{
    ...
    private MouseManager mouseManager;    /*!< Referinta catre obiectul care gestioneaza intrarile din partea utilizatorului in ceea ce priveste mouse-ul.*/
    ...
    {
        wnd = new GameWindow("Maze runner", 960, 960);
        ...
        ///Sa ataseaza ferestrei managerul de la mouse pentru a primi evenimentele furnizate de fereastra.
        ...
        aboutState      = new AboutState(refLink);//gamestate
