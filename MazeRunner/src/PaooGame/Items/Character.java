 ...
 */
public abstract class Character extends Item//Creature
{
    public static final float DEFAULT_SPEED         = 3.0f; /*!< Viteza implicita a unu caracter.*/
    public static final int DEFAULT_CREATURE_WIDTH  = 36;   /*!< Latimea implicita a imaginii caracterului.*/
    ...
    public void Move() {
       ...
       if ((x+xMove > 0) && (x+xMove < 931))
        {
                MoveX();
       }

        if((y+yMove > 0) && (y+yMove < 931))
         {
                MoveY();
         }
    ...
    public void  MoveX()
    {
        ...
        if(xMove>0){//Daca se misca la dreapta
        ...
        else if(xMove<0)//Daca se misca la stanga
        {
