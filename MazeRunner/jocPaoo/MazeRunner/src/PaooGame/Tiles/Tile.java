...
public class Tile
{
    ...
    public static Tile mazeTile        = new MazeTile(1);       /*!< Dala de tip labirint*/
    public static Tile startTile        = new StartTile(2);     /*!< Dala de inceput de joc*/
    public static Tile finishTile        = new FinishTile(3);    /*!< Dala de final de joc*/
