...
public class KeyManager implements KeyListener
{
    ...
    public void Update()
    {
        up    = keys[KeyEvent.VK_UP];      /*!<Redefinirea tastei VK_UP*/
        down  = keys[KeyEvent.VK_DOWN];    /*!<Redefinirea tastei VK_DOWN*/
        left  = keys[KeyEvent.VK_LEFT];    /*!<Redefinirea tastei VK_LEFT*/
        right = keys[KeyEvent.VK_RIGHT];   /*!<Redefinirea tastei VK_RIGHT*/
        space= keys[KeyEvent.VK_SPACE];    /*!<Redefinirea tastei VK_SPACE*/
    }
