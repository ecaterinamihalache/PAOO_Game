...
public abstract class Character extends Item
{
    ...
    public void  MoveX()
    {
        ...
        if(xMove>0){       //Daca player-ul se misca la dreapta
        ...
        else if(xMove<0)     //Daca player-ul se misca la stanga
        {
    ...
    public void MoveY()
    {
           ...
           if(yMove<0){      //Daca player-ul se misca in sus
           ...
           else if(yMove>0){   //Daca player-ul se misca in jos
