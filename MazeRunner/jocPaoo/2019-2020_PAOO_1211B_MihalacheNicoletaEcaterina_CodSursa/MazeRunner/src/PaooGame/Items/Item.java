...
public abstract class Item
{
    ...
    protected int life = 1;                 /*!< Retine viata caracterului.*/
     ...
     */
    public Item(RefLinks refLinks, float x, float y, int width, int height)
    {
        ...
        life    = DEFAULT_LIFE; //Seteaza pe valorile implicite pentru viata
